...
[![Build Status](https://api.travis-ci.org/ropensci/visr.png)](https://travis-ci.org/ropensci/visr)
[![Build status](https://ci.appveyor.com/api/projects/status/3tyojycmeqmj2pcw?svg=true)](https://ci.appveyor.com/project/sckott/visr)
[![codecov.io](https://codecov.io/github/ropensci/visr/coverage.svg?branch=master)](https://codecov.io/github/ropensci/visr?branch=master)
[![rstudio mirror downloads](http://cranlogs.r-pkg.org/badges/visr?color=FAB657)](https://github.com/metacran/cranlogs.app)
...
```{r eval=FALSE}
install.packages("visr", dependencies = TRUE)
```

Or the development version from GitHub

```{r eval=FALSE}
devtools::install_github("ropensci/visr")
```
...
* Please [report any issues or bugs](https://github.com/ropensci/visr/issues).
* License: MIT
* Get citation information for `visr` in R doing `citation(package = 'visr')`
